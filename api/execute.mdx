...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:8080/api/execute"))
...
<Warning>
  Exit code `0` indicates successful execution. Non-zero exit codes indicate compilation errors, runtime errors, or other failures. Check the `output` field for error details.
</Warning>
